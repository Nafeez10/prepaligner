  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Tabs defaultValue="brief" className="w-full">
        <TabsList className="mb-6 inline-flex w-full max-w-[100vw] sm:max-w-none justify-start overflow-x-auto whitespace-nowrap bg-secondary border border-border/10 p-1 rounded-lg [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
